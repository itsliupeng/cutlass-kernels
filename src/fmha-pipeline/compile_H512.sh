...
-o release/fmha_forward_fp8_h512 \
-DGEMM2FP8 -DQBLKSIZE=64 -DKBLKSIZE=64 -DCLUSTERN=1
# -DGEMM2FP8 -DQBLKSIZE=64 -DKBLKSIZE=64 -DCLUSTERN=2 -DEXECMODE=2
# -DGEMM2FP8 -DQBLKSIZE=64 -DKBLKSIZE=64 -DCLUSTERN=2
# -DGEMM2FP8 -DQBLKSIZE=64 -DKBLKSIZE=64 -DCTA256 -DQINRMEM -DCLUSTERN=2
# -DGEMM2FP8 -DGEMM2FP8 -DQBLKSIZE=64 -DKBLKSIZE=64 -DQINRMEM
