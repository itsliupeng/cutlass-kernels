...
-DCUTLASS_DEBUG_TRACE_LEVEL=1 -Xcompiler=-Wno-psabi -Xcompiler=-fno-strict-aliasing \
...
-o release/fmha_forward_fp8_h128 \
-DGEMM2FP8 -DGEMM2FP8 -DQBLKSIZE=128 -DKBLKSIZE=128 -DCTA256 -DQINRMEM